...
(() => {
  ...
  const STRINGS = {
    en: {
      ...
      chessHowTo: "How to play",
      chessTutorialTitle: "Learn to play",
      ...
      chessTutorialScoresBody: "Beat the bot for 10 points on Easy, 20 on Medium and 25 on Hard. PvP wins pay 25 plus +2 per consecutive win (up to +10); draws give 5 and losses 1. Every game also changes your chess rating.",
      chessRating: "Rating",
      chessPointsEarnedPos: "+{points} pts",
      chessPointsEarnedNeg: "{points} pts",
      chessPtsWin: "Win", chessPtsDraw: "Draw", chessPtsLoss: "Loss",
      chessPvp: "Player vs Player",
      chessStreak: " + streak",
      chessTutorialRatingBody: "Your chess rating moves after every game (more for beating a harder bot), and your season points add up on the leaderboard.",
    ...
    es: {
      ...
      chessTurn: "Tu turno",
      chessError: "Algo salió mal, prueba de nuevo.",
      ...
      chessPlay: "Jugar",
      chessLogin: "Inicia sesión para jugar al ajedrez.",
      chessSyncError: "Falló la sincronización de tu perfil. Revisa tu perfil e inténtalo de nuevo.",
      chessHowTo: "Cómo jugar",
      chessTutorialTitle: "Aprende a jugar",
      ...
      chessTutorialControlsBody: "Arrastra una pieza hasta el destino (o toca la pieza y después el casillero). Los puntos marcan tus movimientos legales. Para enrocar, mueve el rey dos casillas hacia la torre.",
      chessTutorialScoresTitle: "Puntos",
      chessTutorialScoresBody: "Ganarle al bot suma 10 puntos en Fácil, 20 en Medio y 25 en Difícil. En PvP la victoria paga 25 más +2 por victoria consecutiva (hasta +10); el empate da 5 y la derrota 1. Cada partida también cambia tu rating de ajedrez.",
      chessRating: "Rating",
      chessPointsEarnedPos: "+{points} pts",
      chessPointsEarnedNeg: "{points} pts",
      chessPtsWin: "Victoria", chessPtsDraw: "Empate", chessPtsLoss: "Derrota",
      chessPvp: "Jugador vs Jugador",
      chessStreak: " + racha",
      chessTutorialRatingBody: "Tu rating de ajedrez se mueve en cada partida (más al ganarle a un bot difícil) y tus puntos de temporada se suman al ranking.",
