(() => {
        ...
        <div class="shell shell-standalone">
          ...
          <footer class="standalone-footer">
            ...
            <div class="standalone-social-links">
              <a href="https://x.com/TellusCoop" target="_blank" rel="noopener noreferrer" aria-label="X / Twitter"><svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.91-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
              <a href="https://www.instagram.com/telluscoop/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
              <a href="https://www.linkedin.com/company/tellus-cooperative/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
              <a href="https://discord.gg/Fy2SgR3XRu" target="_blank" rel="noopener noreferrer" aria-label="Discord"><svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M20.317 4.37a19.791 19.791 0 00-4.885-1.515.074.074 0 00-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 00-5.487 0 12.64 12.64 0 00-.617-1.25.077.077 0 00-.079-.037A19.736 19.736 0 003.677 4.37a.07.07 0 00-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 00.031.057 19.9 19.9 0 005.993 3.03.078.078 0 00.084-.028 14.09 14.09 0 001.226-1.994.076.076 0 00-.041-.106 13.107 13.107 0 01-1.872-.892.077.077 0 01-.008-.128 10.2 10.2 0 00.372-.292.074.074 0 01.077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 01.078.01c.12.098.246.198.373.292a.077.077 0 01-.006.127 12.299 12.299 0 01-1.873.892.077.077 0 00-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 00.084.028 19.839 19.839 0 006.002-3.03.077.077 0 00.032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 00-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg></a>
            </div>
          </footer>
        </div>
  ...
  function qrView() {
    ...
    return `<div class="qr-monkey-shell"><div class="qr-tool-head"><span class="eyebrow">Tellus Cooperative</span><h2>The local QR code generator</h2><p>Diseña, personaliza y descarga tu código QR. Todo se genera localmente.</p></div><nav class="qr-type-tabs" aria-label="QR content type">${QR_TYPES.map(([id, label]) => `<button type="button" class="${type === id ? "active" : ""}" data-qr-type="${id}">${label}</button>`).join("")}</nav><div class="qr-workspace"><section class="qr-controls"><form id="qr-form"><div class="qr-fold open"><button type="button" class="qr-fold-toggle" data-qr-fold="content"><span>◉</span> ENTER CONTENT <span>−</span></button><div class="qr-fold-body"><div class="field"><label for="qr-label">Nombre interno</label><input id="qr-label" name="label" placeholder="ej: Bio link" value="${esc(data.label)}" /></div><div class="qr-fields">${qrFields(type, data)}</div></div></div><div class="qr-fold"><button type="button" class="qr-fold-toggle" data-qr-fold="colors"><span>✦</span> SET COLORS <span>+</span></button><div class="qr-fold-body"><div class="qr-color-grid"><div class="field"><label>QR color</label><input name="bodyColor" type="color" value="${esc(data.bodyColor)}" /></div><div class="field"><label>Background</label><input name="bgColor" type="color" value="${esc(data.bgColor)}" /></div><div class="field"><label>Eye color</label><input name="eyeColor" type="color" value="${esc(data.eyeColor)}" /></div></div><label class="check"><input name="mode" value="transparent" type="checkbox" ${data.mode === "transparent" ? "checked" : ""}/> Fondo transparente</label></div></div><div class="qr-fold"><button type="button" class="qr-fold-toggle" data-qr-fold="logo"><span>▧</span> ADD LOGO IMAGE <span>+</span></button><div class="qr-fold-body"><div class="field"><label for="qr-logo">Logo URL</label><input id="qr-logo" name="logo" type="url" placeholder="https://…/logo.png" value="${esc(data.logo)}" /></div><div class="field"><label for="qr-logo-file">Upload logo</label><input id="qr-logo-file" name="logoFile" type="file" accept="image/png,image/jpeg,image/svg+xml" /></div></div></div><div class="qr-fold"><button type="button" class="qr-fold-toggle" data-qr-fold="design"><span>▦</span> CUSTOMIZE DESIGN <span>+</span></button><div class="qr-fold-body"><div class="qr-design-grid"><div class="field"><label>Body shape</label><select name="body">${["square", "rounded", "circle", "dot", "rounded-pointed"].map(v => `<option ${data.body === v ? "selected" : ""}>${v}</option>`).join("")}</select></div><div class="field"><label>Eye frame</label><select name="eye">${["frame0", "frame1", "frame2", "frame3", "frame4", "frame5"].map(v => `<option ${data.eye === v ? "selected" : ""}>${v}</option>`).join("")}</select></div><div class="field"><label>Export</label><select name="file"><option value="png">PNG</option><option value="svg">SVG</option></select></div></div></div></div><button class="button button-primary qr-create" type="submit">${icon("qr-code")} Create QR Code</button></form></section><section class="qr-preview-panel"><div class="qr-preview-label">PREVIEW</div>${preview ? `<h3>${esc(preview.label || "Your QR code")}</h3><img class="qr-image-preview" src="${esc(preview.image)}" alt="Código QR generado" />` : `<div class="qr-empty-preview"><span>QR</span><p>Completa el contenido y crea tu código</p></div>`}<div class="qr-downloads">${preview ? `<button class="button button-primary" data-qr-download="png">${icon("download")} Download PNG</button><button class="button button-secondary" data-qr-download="svg">.SVG</button>` : ""}</div></section></div>${state.session && !state.preview ? `<p class="qr-save-note">Los códigos generados se pueden guardar en tu banco Tellus.</p>` : ""}</div>`;
  }
